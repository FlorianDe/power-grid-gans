...
def draw_qq_plot(
    ...
    if QQReferenceLine.FIRST_THIRD_QUARTIL in reference_lines:
        ...
        ax.plot(theo_quant_values, slope * theo_quant_values + intercept, 'r-', alpha=0.9, label=translate(__Keys.LBL_FIRST_THIRD_QUARTIL))
    ...
    if QQReferenceLine.LEAST_SQUARES_REGRESSION in reference_lines:
        ...
        ax.plot(theo_quant_values, slope * theo_quant_values + intercept, 'k-', alpha=0.9, label=translate(__Keys.LBL_LEAST_SQUARES_REGRESSION))
