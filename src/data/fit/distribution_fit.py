...
def test_fit_against_all_distributions(data: npt.ArrayLike, bins: int, error_fn: Callable[[npt.ArrayLike, npt.ArrayLike], float]) -> list[DistributionFit]:
    ...
    for ii, distribution_name in enumerate([d for d in _distn_names if d not in ['levy_stable', 'studentized_range']]):
